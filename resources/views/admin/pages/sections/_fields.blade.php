...
{{-- Enabled toggle --}}
<label class="mb-3 flex items-center justify-between rounded-xl bg-slate-50 p-3">
    <div>
...
@switch($section->type->value)
    ...
    @case('testimonials')
        ...
        <div><label class="field-label">العنوان الفرعي</label>
            <textarea name="subtitle" rows="2" class="field-input">{{ old('subtitle', $s['subtitle'] ?? '') }}</textarea></div>
        <p class="rounded-xl bg-slate-50 p-3 text-xs text-slate-500">تُدار آراء العملاء من زر «إدارة الآراء».</p>
        @break
    ...
    @case('offers')
        ...
        <div><label class="field-label">العنوان الفرعي</label>
            <textarea name="subtitle" rows="2" class="field-input">{{ old('subtitle', $s['subtitle'] ?? '') }}</textarea></div>
        <p class="rounded-xl bg-slate-50 p-3 text-xs text-slate-500">تُدار العروض والأسعار من زر «إدارة العروض».</p>
        @break
    ...
    @case('trust')
        ...
        <p class="rounded-xl bg-slate-50 p-3 text-xs text-slate-500">تُدار الأسئلة الشائعة من زر «إدارة الأسئلة الشائعة».</p>
        @break
